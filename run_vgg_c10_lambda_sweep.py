'''
    VGG16 CIFAR10 WTA-Rev lambda sweep (alpha=4 fixed, best from alpha sweep)
...
EXPERIMENTS = [
    {'lmb': 1e-9,  'gpu': 0, 'dir': '_vgg_c10_lambda_sweep/lmb_1e-09'},
    {'lmb': 5e-9,  'gpu': 1, 'dir': '_vgg_c10_lambda_sweep/lmb_5e-09'},
    {'lmb': 1e-8,  'gpu': 2, 'dir': '_vgg_c10_lambda_sweep/lmb_1e-08'},
    {'lmb': 3e-8,  'gpu': 3, 'dir': '_vgg_c10_lambda_sweep/lmb_3e-08'},
    {'lmb': 1e-7,  'gpu': 4, 'dir': '_vgg_c10_lambda_sweep/lmb_1e-07'},
    {'lmb': 3e-7,  'gpu': 5, 'dir': '_vgg_c10_lambda_sweep/lmb_3e-07'},
    {'lmb': 5e-7,  'gpu': 6, 'dir': '_vgg_c10_lambda_sweep/lmb_5e-07'},
    {'lmb': 1e-6,  'gpu': 7, 'dir': '_vgg_c10_lambda_sweep/lmb_1e-06'},
]
...
def generate_config(exp):
    ...
    content = content.replace(
        ...
        f"conf.exp_set_name='vgg-c10-lmb-{exp['lmb']:.0e}'"
    )
...
def main():
    ...
    for exp in EXPERIMENTS:
        ...
        print(f'[GPU {exp["gpu"]}] VGG16 C10 WTA-Rev alpha={FIXED_ALPHA} lambda={exp["lmb"]} -> {log_file}')
