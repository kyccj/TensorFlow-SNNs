'''
    Spikformer CIFAR10 WTA-Rev lambda sweep on free GPUs (0, 3, 4, 5)
    Already running: baseline (GPU 6), lambda=5e-8 (GPU 7)
'''
import subprocess
import os
...
EXPERIMENTS = [
    {'lmb': 1e-9,  'gpu': 0, 'dir': '_spikformer_c10_lmb_1e-09'},
    {'lmb': 1e-8,  'gpu': 3, 'dir': '_spikformer_c10_lmb_1e-08'},
    {'lmb': 1e-7,  'gpu': 4, 'dir': '_spikformer_c10_lmb_1e-07'},
    {'lmb': 5e-7,  'gpu': 5, 'dir': '_spikformer_c10_lmb_5e-07'},
]
...
def main():
    ...
    for exp in EXPERIMENTS:
        ...
        print(f'[GPU {exp["gpu"]}] Spikformer C10 WTA-Rev lambda={exp["lmb"]} -> {log_file}')
