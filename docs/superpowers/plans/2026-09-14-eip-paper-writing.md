...
[근거] baseline 96.720 ± 0.067 @ 488,619 (n=4)  vs  제안법 ρ=3e-3 96.650 @ 235,802 (n=4).
       차이 −0.070%p. 무손실선 96.585 위에 있다.
[인용] 없음 (본 연구 결과)
...
**검산:** baseline 행이 4개, 평균이 96.720 @ 488,619 이어야 한다 (규칙 3 적용 후).
2개만 나오면 글롭이 일부만 잡은 것이고, 6개가 나오면 규칙 3 을 안 건 것이다.
...
- [ ] **Step 4: 초록을 마지막에 쓴다.** 150~200 단어. 구성: 문제 1문장 → 관찰 1문장 →
      핵심 수치 2문장(51.7% 감소 / 같은 예산에서 −15.4% 뉴런) → 기여 1문장 → 검증 범위 1문장.
- [ ] **Step 5: 검증**
