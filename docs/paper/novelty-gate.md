...
```
CONTRIB-1: 같은 스파이크 예산에서 활성 뉴런을 13.1% 적게 쓴다 (ANCOVA 계수 0.869,
           t=-21.5, n=21, ResNet19/CIFAR-10). 가중 설계 간 등가성 관찰은 동기로만
           남긴다 — 수치·그림 없이, VGG16/CIFAR-10 탐색에서 관찰했다고만 밝힌다
           (2026-09-14 결정, spec §2 A8). [선점 안 됨. 논문의 무게중심]
