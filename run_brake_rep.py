...
ALPHA = 7
RESERVED = {1, 4, 5, 6, 7}   # 1: tight cap, 4: SF transfer, 5: brake_rep running, 6/7: juyun

JOBS = [
    dict(name='br_on_r2',  rho=5.8e-4, floor=0.22, cap=1.5),
    dict(name='br_on_r3',  rho=5.8e-4, floor=0.22, cap=1.5),
    dict(name='br_off_r4', rho=5.8e-4, floor=0.0,  cap=1e9),
]
