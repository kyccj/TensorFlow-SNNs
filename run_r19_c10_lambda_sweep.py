'''
    ResNet19 CIFAR10 WTA-Rev lambda sweep (alpha=4 fixed)
    Lambda values: 1e-9, 5e-9, 1e-8, 3e-8, 1e-7, 3e-7, 5e-7, 1e-6
    GPU: 0-7
'''
import subprocess
import os
...
EXPERIMENTS = [
    {'lmb': 1e-9,  'gpu': 0, 'dir': '_r19_c10_lambda_sweep/lmb_1e-09'},
    {'lmb': 5e-9,  'gpu': 1, 'dir': '_r19_c10_lambda_sweep/lmb_5e-09'},
    {'lmb': 1e-8,  'gpu': 2, 'dir': '_r19_c10_lambda_sweep/lmb_1e-08'},
    {'lmb': 3e-8,  'gpu': 3, 'dir': '_r19_c10_lambda_sweep/lmb_3e-08'},
    {'lmb': 1e-7,  'gpu': 4, 'dir': '_r19_c10_lambda_sweep/lmb_1e-07'},
    {'lmb': 3e-7,  'gpu': 5, 'dir': '_r19_c10_lambda_sweep/lmb_3e-07'},
    {'lmb': 5e-7,  'gpu': 6, 'dir': '_r19_c10_lambda_sweep/lmb_5e-07'},
    {'lmb': 1e-6,  'gpu': 7, 'dir': '_r19_c10_lambda_sweep/lmb_1e-06'},
]
...
def generate_config(exp):
    ...
    # ResNet19 (already default) + CIFAR10
    ...
    content = content.replace(
        ...
        f"conf.exp_set_name='r19-c10-lmb-{exp['lmb']:.0e}'"
    )
...
def main():
    ...
    for exp in EXPERIMENTS:
        ...
        print(f'[GPU {exp["gpu"]}] R19 C10 WTA-Rev alpha={FIXED_ALPHA} lambda={exp["lmb"]} -> {log_file}')
