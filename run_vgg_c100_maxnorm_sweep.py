'''
    VGG16 CIFAR100 - MaxNorm vs MaxNorm+Encourage sweep
    alpha=7, 310 epochs
...
GPU_EXPERIMENTS = {
    0: {'lmb': 1e-8,  'maxnorm': True,  'encourage': False, 'dir': '_vgg_c100_maxnorm/maxnorm_lmb_1e-08'},
    1: {'lmb': 1e-7,  'maxnorm': True,  'encourage': False, 'dir': '_vgg_c100_maxnorm/maxnorm_lmb_1e-07'},
    2: {'lmb': 3e-7,  'maxnorm': True,  'encourage': False, 'dir': '_vgg_c100_maxnorm/maxnorm_lmb_3e-07'},
    3: {'lmb': 1e-6,  'maxnorm': True,  'encourage': False, 'dir': '_vgg_c100_maxnorm/maxnorm_lmb_1e-06'},
    4: {'lmb': 1e-8,  'maxnorm': True,  'encourage': True,  'dir': '_vgg_c100_maxnorm/maxnorm_enc_lmb_1e-08'},
    5: {'lmb': 1e-7,  'maxnorm': True,  'encourage': True,  'dir': '_vgg_c100_maxnorm/maxnorm_enc_lmb_1e-07'},
    6: {'lmb': 3e-7,  'maxnorm': True,  'encourage': True,  'dir': '_vgg_c100_maxnorm/maxnorm_enc_lmb_3e-07'},
    7: {'lmb': 1e-6,  'maxnorm': True,  'encourage': True,  'dir': '_vgg_c100_maxnorm/maxnorm_enc_lmb_1e-06'},
}
...
def main():
    print(f'VGG16-C100 MaxNorm sweep (alpha={FIXED_ALPHA})')
    print('GPU mapping:')
