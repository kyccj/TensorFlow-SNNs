...
A related question is why $\lambda$ moves the way it does. It drops 44\% at
epoch 201, from $4.75\times10^{-7}$ to $2.68\times10^{-7}$, coinciding with
CutMix being turned off; whether it also coincides with a specific point in
the learning-rate schedule has not been checked. If it does, the ratio
...
\S\ref{sec:exp-analysis}) uses an asymmetric surrogate (bias 0.8), while the
