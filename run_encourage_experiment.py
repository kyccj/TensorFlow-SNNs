'''
    Encourage term experiment - MaxNorm + Encourage vs MaxNorm-only vs Softmax
    VGG16 CIFAR10, alpha=4, 310 epochs

    GPU 0-3: MaxNorm + Encourage (lambdas: 1e-8, 1e-7, 3e-7, 1e-6)
    GPU 4-7: Softmax + Encourage (lambdas: 1e-8, 1e-7, 3e-7, 1e-6)
'''
import subprocess
import os
import sys
...
GPU_EXPERIMENTS = {
    0: {'lmb': 1e-8,  'maxnorm': True,  'encourage': True, 'dir': '_encourage/maxnorm_enc_lmb_1e-08'},
    1: {'lmb': 1e-7,  'maxnorm': True,  'encourage': True, 'dir': '_encourage/maxnorm_enc_lmb_1e-07'},
    2: {'lmb': 3e-7,  'maxnorm': True,  'encourage': True, 'dir': '_encourage/maxnorm_enc_lmb_3e-07'},
    3: {'lmb': 1e-6,  'maxnorm': True,  'encourage': True, 'dir': '_encourage/maxnorm_enc_lmb_1e-06'},
    4: {'lmb': 1e-8,  'maxnorm': False, 'encourage': True, 'dir': '_encourage/softmax_enc_lmb_1e-08'},
    5: {'lmb': 1e-7,  'maxnorm': False, 'encourage': True, 'dir': '_encourage/softmax_enc_lmb_1e-07'},
    6: {'lmb': 3e-7,  'maxnorm': False, 'encourage': True, 'dir': '_encourage/softmax_enc_lmb_3e-07'},
    7: {'lmb': 1e-6,  'maxnorm': False, 'encourage': True, 'dir': '_encourage/softmax_enc_lmb_1e-06'},
}
...
def gpu_pipeline(gpu, exp):
    tag = 'MaxNorm+Enc' if exp['maxnorm'] else 'Softmax+Enc'
...
def main():
    print(f'Encourage term experiment (alpha={FIXED_ALPHA})')
    print('GPU mapping:')
