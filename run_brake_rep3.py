...
ALPHA = 7
RESERVED = {1, 3, 4, 5, 6, 7}   # GPU 0,2만 사용   # 1: tight cap, 4: SF transfer, 5: brake_rep running, 6/7: juyun

JOBS = [
    dict(name='br_on_r5',  rho=5.8e-4, floor=0.22, cap=1.5),
    dict(name='br_off_r5', rho=5.8e-4, floor=0.0,  cap=1e9),
]
