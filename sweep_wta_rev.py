...
SWEEP_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), '_sweep_wta_rev')
...
def generate_config(lmb, gpu_id, run_dir):
    ...
    content = content.replace(
        ...
        f"conf.exp_set_name='EIP-SNN-26_wta-rev-lambda-{lmb}'"
    )
