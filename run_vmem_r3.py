...
SWEEP_DIR = os.path.join(PROJECT_ROOT, '_vmr3')
...
#        이름        gain    lambda
JOBS = [
    ('g2_5e-7_r3', '2.0', '5E-7'),   # 95.05% @ 37,139 의 3번째 run (스윕의 r2 와 합쳐 n=3)
]
...
def main():
    ...
    preflight(pending)
    print(f'--- gain=2 5e-7 replicate: {len(pending)} runs ---', flush=True)
    while pending:
